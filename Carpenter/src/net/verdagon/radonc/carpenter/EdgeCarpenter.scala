...
import net.verdagon.radonc.templar.types.InterfaceDefinition2
import net.verdagon.radonc.templar.{Edge2, Impl2, InterfaceEdgeBlueprint}
import net.verdagon.radonc.{vassert, vfail}

object EdgeCarpenter {
  def assembleEdges(
    functions: List[net.verdagon.radonc.templar.Function2],
