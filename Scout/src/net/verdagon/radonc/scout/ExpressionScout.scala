...
import net.verdagon.radonc.{scout, vimpl}
import net.verdagon.radonc.scout.Scout.{noDeclarations, noVariableUses}
import net.verdagon.radonc.scout.patterns.PatternScout
import net.verdagon.radonc.scout.patterns.PatternScout.{InitialRulesAndRunes, RuleState, RuleStateBox}
import net.verdagon.radonc.scout.rules.RuleScout
