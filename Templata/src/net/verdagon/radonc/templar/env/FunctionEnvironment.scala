...
import net.verdagon.radonc.scout.LocalVariable1
import net.verdagon.radonc.templar.templata.{ITemplata, Queriable2}
import net.verdagon.radonc.templar.types.{Coord, FullName2, StructRef2, Variability}
...
case class FunctionEnvironment(
  ...
  scoutedLocals: Set[LocalVariable1],
  ...
  def addEntry(name: String, entry: IEnvEntry): FunctionEnvironment = {
    FunctionEnvironment(
      parentEnv,
      fullName,
      function,
  ...
  def addEntries(newEntries: Map[String, List[IEnvEntry]]): FunctionEnvironment = {
    FunctionEnvironment(
      parentEnv,
      fullName,
      function,
