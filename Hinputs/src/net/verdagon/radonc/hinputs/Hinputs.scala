package net.verdagon.radonc.hinputs

import net.verdagon.radonc.templar.{CompleteProgram2, Edge2, InterfaceEdgeBlueprint, Program2}
import net.verdagon.radonc.templar.templata.{FunctionBanner2, Prototype2, Signature2}
import net.verdagon.radonc.templar.types.{InterfaceRef2, StructRef2}
