...
//  }
  ...
  def vonifyFullName(hinputs: Hinputs, hamuts: HamutsBox, fullName2: FullName2[IName2]): VonArray = {
    VonArray(None, fullName2.steps.map(step => translateName(hinputs, hamuts, step)).toVector)
  }
